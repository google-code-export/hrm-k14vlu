...
{
    [Export(ViewModelTypes.ListSubjectSummaryViewModel, typeof(ViewModelBase))]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    public class ListSubjectSummaryViewModel : ViewModelBase, IViewModel
    {
        #region Private Members

        private ITrainingModel _modelTrain;
        public const string ViewKey = "WM_LISTSUBJECTSUMMARY";
